...
/**
 * Created by kamcio on 05.05.17. Denne klassen brukes for å lage siste aktiviteten i Finnbilligstdrikke knappen,
...
public class Alcohol2 extends Fragment {
...
/*dette hjelper meg å komme tilbake til en lagret instans tilstand*/
    ...
    public void updateAlcohol(int position){
        ...
        ArrayList<Vare> data  =Finnbilligstdrikke.getUnfiltered();
        ...
        try {
            ...
            // her fanges opp unntaket dersom datalisten har tom streng for bildet og standard bilde fra appen av en flaske brukes i steden da
